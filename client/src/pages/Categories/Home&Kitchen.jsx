...
const HomeKitchen = () => {
  ...
  const [subcategories] = useState(["All", "Furniture", "Decor", "Kitchen Appliances"]); // Static subcategories
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/product/category/home`);
