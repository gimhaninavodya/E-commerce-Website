...
const Sports = () => {
  ...
  const [subcategories] = useState(["All", "Fitness", "Outdoor", "Team Sports"]); // Static subcategories
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/product/category/sports`);
