...
const Electronics = () => {
  ...
  const [subcategories] = useState(["All", "Mobiles", "Laptops", "Cameras"]); // Static subcategories
  ...
  useEffect(() => {
    ...
    const fetchItems = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/product/category/electronics`);
